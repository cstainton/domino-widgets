...
for(const browserName of browsers){
 ...
 for(const backend of ['gwt','teavm'])projects.push({name:browserName==='chromium'?backend:backend+'-'+browserName,testMatch:['contracts.spec.js','gallery.spec.js','native.spec.js','interactions.spec.js'],use:{...use,baseURL:'http://127.0.0.1:'+port+'/showcase-'+backend+'/target/site/'}});
