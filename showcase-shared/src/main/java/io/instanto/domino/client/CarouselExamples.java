        ...
        element.appendChild(Row.create()
                ...
                .appendChild(Column.span6()
                        .appendChild(Card.create()
                                .appendChild(Carousel.create()
                                        .appendChild(Slide.create(img("images/image-gallery/11.jpg"))
                                                .setLabel("Slide 1")
                                                .setDescription("First slide description")
                                        )
                                        .appendChild(Slide.create(img("images/image-gallery/12.jpg"))
                                                .setLabel("Slide 2")
                                                .setDescription("Second slide description")
                                        )
                                        .appendChild(Slide.create(img("images/image-gallery/19.jpg"))
                                                .setLabel("Slide 3")
                                                .setDescription("Third slide description")
                                        )
                                        .appendChild(Slide.create(img("images/image-gallery/9.jpg"))
                                                .setLabel("Slide 4")
                                                .setDescription("Fourth slide description")
                                        )
                                        .appendChild(Slide.create(img("images/image-gallery/6.jpg"))
                                                .setLabel("Slide 5")
