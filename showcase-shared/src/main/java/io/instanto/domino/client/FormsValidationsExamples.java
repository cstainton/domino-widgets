...
public final class FormsValidationsExamples implements org.dominokit.domino.ui.style.DominoCss {
 ...
 public HTMLDivElement render(){
        ...
        readOnlyCard = Card.create("READ ONLY");initHelperText();
initIcons();
initWordCount();
initValidations();
initReadOnly();
element.appendChild(countsCard);
element.appendChild(validationsCard);
element.appendChild(readOnlyCard);return element.element();}
