...
public final class SlidersExamples implements org.dominokit.domino.ui.style.DominoCss {
 ...
 public HTMLDivElement render(){
        ...
        sampleCard = Card.create("SLIDERS EXAMPLE");initBasic();
initColors();
initExample();
element.appendChild(basicCard);
element.appendChild(colorsSlidersCard);
element.appendChild(sampleCard);return element.element();}
