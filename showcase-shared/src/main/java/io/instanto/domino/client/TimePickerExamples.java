// Adapted from DominoKit/domino-ui-demo at 51e1f75d43179a544c010ca5e88517c93263eeed; see upstream/showcase-lock.json.
        ...
        element
                .appendChild(Card.create("INLINE TIMEPICKER")
                        ...
                        .appendChild(Row.create()
                                ...
                                .span4(TimePicker.create(new org.gwtproject.i18n.shared.cldr.impl.BrowserDateTimeFormatInfo("ar")))
                                .span4(TimePicker.create(new org.gwtproject.i18n.shared.cldr.impl.BrowserDateTimeFormatInfo("es")))
                        )
        ...
        element
                .appendChild(Card.create("TIME BOX")
                        ...
                        .appendChild(Row.create()
                                ...
                                .span4(TimeBox.create("With pattern", new org.gwtproject.i18n.shared.cldr.impl.BrowserDateTimeFormatInfo("ar"))
                                        .setPattern("HH:mm:ss")
                                        .withPopover((parent, popover) -> popover.addCss(dui_accent_blue))
                                        .withTimePicker((parent, timePicker) -> timePicker
                                                .withHeader())
                                )
                                .span4(TimeBox.create("With parse strict", new org.gwtproject.i18n.shared.cldr.impl.BrowserDateTimeFormatInfo("es"))
                                        .setPattern("HH-mm-ss")
                                        .setParseStrict(true)
